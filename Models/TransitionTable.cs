namespace WebApplication1.Models
{
    ...
    class accepted
    {
       ...
       public string[][] accept = new string[170][2];
        ...
        accept[States.E][token]="struct";
        accept[States.F][type]="Accept";
        accept[States.F][token]="struct";
        accept[States.G][type]="Accept";
        accept[States.G][token]="struct";
        accept[States.H][type]="Accept";
        accept[States.H][token]="struct";
        accept[States.I][type]="Accept";
        accept[States.I][token]="struct";
        accept[States.J][type]="Accept";
        accept[States.J][token]="struct";
        accept[States.K][type]="Accept";
        accept[States.K][token]="struct";
        accept[States.L][type]="Accept";
        accept[States.L][token]="struct";
        accept[States.M][type]="Accept";
        accept[States.M][token]="struct";
        accept[States.N][type]="Accept";
        accept[States.N][token]="struct";
        accept[States.O][type]="Accept";
        accept[States.O][token]="struct";
        accept[States.P][type]="Accept";
        accept[States.P][token]="struct";
        accept[States.Q][type]="Accept";
        accept[States.Q][token]="struct";
        accept[States.R][type]="Accept";
        accept[States.R][token]="struct";
        accept[States.S][type]="Accept";
        accept[States.S][token]="struct";
        accept[States.T][type]="Accept";
        accept[States.T][token]="struct";
        accept[States.U][type]="Accept";
        accept[States.U][token]="struct";
        accept[States.AF][type]="Accept";
        accept[States.AF][token]="struct";
        accept[States.AG][type]="Accept";
        accept[States.AG][token]="struct";
        accept[States.AH][type]="Accept";
        accept[States.AH][token]="struct";
        accept[States.AK][type]="Accept";
        accept[States.AK][token]="struct";
        accept[States.AL][type]="Accept";
        accept[States.AL][token]="struct";
        accept[States.AM][type]="Accept";
        accept[States.AM][token]="struct";
        accept[States.AN][type]="Accept";
        accept[States.AN][token]="struct";
        accept[States.AO][type]="Accept";
        accept[States.AO][token]="struct";
        accept[States.AP][type]="Accept";
        accept[States.AP][token]="struct";
        accept[States.AQ][type]="Accept";
        accept[States.AQ][token]="struct";
        accept[States.AR][type]="Accept";
        accept[States.AR][token]="struct";
        accept[States.AS][type]="Accept";
        accept[States.AS][token]="struct";
        accept[States.AT][type]="Accept";
        accept[States.AT][token]="struct";
        accept[States.AU][type]="Accept";
        accept[States.AU][token]="struct";
        accept[States.AV][type]="Accept";
        accept[States.AV][token]="struct";
        accept[States.AW][type]="Accept";
        accept[States.AW][token]="struct";
        accept[States.AX][type]="Accept";
        accept[States.AX][token]="struct";
        accept[States.AY][type]="Accept";
        accept[States.AY][token]="struct";
        accept[States.AZ][type]="Accept";
        accept[States.AZ][token]="struct";
        accept[States.BA][type]="Accept";
        accept[States.BA][token]="struct";
        accept[States.BB][type]="Accept";
        accept[States.BB][token]="struct";
        accept[States.BC][type]="Accept";
        accept[States.BC][token]="struct";
        accept[States.BD][type]="Accept";
        accept[States.BD][token]="struct";
        accept[States.BE][type]="Accept";
        accept[States.BE][token]="struct";
        accept[States.BF][type]="Accept";
        accept[States.BF][token]="struct";
        accept[States.BG][type]="Accept";
        accept[States.BG][token]="struct";
        accept[States.BH][type]="Accept";
        accept[States.BH][token]="struct";
        accept[States.BP][type]="Accept";
        accept[States.BP][token]="struct";
        accept[States.CH][type]="Accept";
        accept[States.CH][token]="struct";
/////////////////////////////////////////////////
