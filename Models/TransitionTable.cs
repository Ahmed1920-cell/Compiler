namespace WebApplication1.Models
{
    ...
    /*class accepted
    {
        ...
        accept[States.E,type]="Accept";
        accept[States.E,token]="Arithmetic Operation";
        accept[States.F,type]="Accept";
        accept[States.F,token]="Access Operator";
        accept[States.G,type]="Accept";
        accept[States.G,token]="Arithmetic Operation";
        accept[States.H,type]="Accept";
        accept[States.H,token]="Constant";
        accept[States.I,type]="Accept";
        accept[States.I,token]="Constant";
        accept[States.J,type]="Accept";
        accept[States.J,token]="Constant";
        accept[States.K,type]="Accept";
        accept[States.K,token]="Constant";
        accept[States.L,type]="Accept";
        accept[States.L,token]="Constant";
        accept[States.M,type]="Accept";
        accept[States.M,token]="Constant";
        accept[States.N,type]="Accept";
        accept[States.N,token]="Constant";
        accept[States.O,type]="Accept";
        accept[States.O,token]="Constant";
        accept[States.P,type]="Accept";
        accept[States.P,token]="Constant";
        accept[States.Q,type]="Accept";
        accept[States.Q,token]="Constant";
        accept[States.R,type]="Accept";
        accept[States.R,token]="relational operators";
        accept[States.S,type]="Accept";
        accept[States.S,token]="Assignment operator";
        accept[States.T,type]="Accept";
        accept[States.T,token]="relational operators";
        accept[States.U,type]="Accept";
        accept[States.U,token]="Arithmetic Operation";
        accept[States.AF,type]="Accept";
        accept[States.AF,token]="Braces";
        accept[States.AG,type]="Accept";
        accept[States.AG,token]="Braces";
        accept[States.AH,type]="Accept";
        accept[States.AH,token]="Arithmetic Operation";
        accept[States.AK,type]="Accept";
        accept[States.AK,token]="Braces";
        accept[States.AL,type]="Accept";
        accept[States.AL,token]="Braces";
        accept[States.AM,type]="Accept";
        accept[States.AM,token]="Logic operators";
        accept[States.AN,type]="Accept";
        accept[States.AN,token]="Quotation Mark";
        accept[States.AO,type]="Accept";
        accept[States.AO,token]="Quotation Mark";
        accept[States.AP,type]="Accept";
        accept[States.AP,token]="relational operators";
        accept[States.AQ,type]="Accept";
        accept[States.AQ,token]="Logic operators";
        accept[States.AR,type]="Accept";
        accept[States.AR,token]="Logic operators";
        accept[States.AS,type]="Accept";
        accept[States.AS,token]="Constant";
        accept[States.AT,type]="Accept";
        accept[States.AT,token]="Constant";
        accept[States.AU,type]="Accept";
        accept[States.AU,token]="Constant";
        accept[States.AV,type]="Accept";
        accept[States.AV,token]="Constant";
        accept[States.AW,type]="Accept";
        accept[States.AW,token]="Constant";
        accept[States.AX,type]="Accept";
        accept[States.AX,token]="Constant";
        accept[States.AY,type]="Accept";
        accept[States.AY,token]="Constant";
        accept[States.AZ,type]="Accept";
        accept[States.AZ,token]="Constant";
        accept[States.BA,type]="Accept";
        accept[States.BA,token]="Constant";
        accept[States.BB,type]="Accept";
        accept[States.BB,token]="Constant";
        accept[States.BC,type]="Accept";
        accept[States.BC,token]="Constant";
        accept[States.BD,type]="Accept";
        accept[States.BD,token]="relational operators";
        accept[States.BE,type]="Accept";
        accept[States.BE,token]="Constant";
        accept[States.BF,type]="Accept";
        accept[States.BF,token]="relational operators";
        accept[States.BG,type]="Accept";
        accept[States.BG,token]="relational operators";
        accept[States.BH,type]="Accept";
        accept[States.BH,token]="Constant";
        accept[States.BP,type]="Accept";
        accept[States.BP,token]="Condition";
        accept[States.CH,type]="Accept";
        accept[States.CH,token]="End Statement";
/////////////////////////////////////////////////
        accept[States.CW,type]="Accept";
        accept[States.CW,token]="Character";
        accept[States.CZ,type]="Accept";
        accept[States.CZ,token]="Condition";
        accept[States.DA,type]="Accept";
        accept[States.DA,token]="Integer";
        accept[States.DC,type]="Accept";
        accept[States.DC,token]="Void";
        accept[States.DG,type]="Accept";
        accept[States.DG,token]="Struct";
        accept[States.DN,type]="Accept";
        accept[States.DN,token]="Switch";
        accept[States.DQ,type]="Accept";
        accept[States.DQ,token]="Float";
        accept[States.DW,type]="Accept";
        accept[States.DW,token]="SInteger";
        accept[States.DX,type]="Accept";
        accept[States.DX,token]="Inclusion";
        accept[States.EC,type]="Accept";
        accept[States.EC,token]="Inheritance";
        accept[States.EH,type]="Accept";
        accept[States.EH,token]="String";
        accept[States.EI,type]="Accept";
        accept[States.EI,token]="SFloat";
        accept[States.EN,type]="Accept";
        accept[States.EN,token]="Boolean";
        accept[States.EO,type]="Accept";
        accept[States.EO,token]="Stat Statement";
        accept[States.ET,type]="Accept";
        accept[States.ET,token]="Class";
        accept[States.FA,type]="Accept";
        accept[States.FA,token]="Return";
        accept[States.FF,type]="Accept";
        accept[States.FF,token]="Loop";
        accept[States.FJ,type]="Accept";
        accept[States.FJ,token]="Switch";
        accept[States.FL,type]="Accept";
        accept[States.FL,token]="Loop";
        accept[States.FN,type]="Accept";
        accept[States.FN,token]="Break";
    ...
    class TransitionTable
    {
        static void Main(string[] args)
        {
            ...
            acceptanceState[] acceptanceStates = new acceptanceState[66];
            for (int i = 0; i < 66; i++)
            {
                acceptanceStates[i] = new acceptanceState();
            }

            acceptanceStates[0].state = States.E;
            acceptanceStates[0].token = "Arithmetic Operation";

            acceptanceStates[1].state = States.F;
            acceptanceStates[1].token = "Access Operator";
        }
    }
}
